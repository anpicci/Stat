    ...
    if(os.path.exists(path)):
        ...
        if len(categories)>=1:
            ...
            if len(years)>1:
                ...
                cmd = "combine -M MultiDimFit " + rootdc + " -m 125 -t -1 --redefineSignalPOIs " + modComb + " --setParameterRanges "+ intervalstr + " -n " + modelname + " " + optionalsSM # + " --freezeParameters r --setParameters r=1"
                print cmd
