...
def plotter_pull_v2(flavor,fitdiag_file,SignalFile,region,lumi,Mass,outdir="./output",sb=True,year=161718,LogX=True):
...
#        legend.AddEntry(h_other_prefit, "Other Backgrounds", "f")
    ...
    for hbin in range(0,data_pull.GetNbinsX()+1):
      if (h_postfit['totalv2'].GetBinContent(hbin)>0):
        ...
        if (math.fabs(h_data.GetBinError(hbin)*h_data.GetBinError(hbin) - h_postfit['totalv2'].GetBinError(hbin)* h_postfit['totalv2'].GetBinError(hbin)) < 0.001):
          data_pull.SetBinContent(hbin,0)
        elif (h_postfit['totalv2'].GetBinError(hbin) > h_data.GetBinError(hbin) ):
          data_pull.SetBinContent(hbin,0)
        else:
          sigmaBILL = math.sqrt(  h_data.GetBinError(hbin)*h_data.GetBinError(hbin)  -    h_postfit['totalv2'].GetBinError(hbin)* h_postfit['totalv2'].GetBinError(hbin) )
          data_pull.SetBinContent(hbin,( h_data.GetBinContent(hbin) -  h_postfit['totalv2'].GetBinContent(hbin) )/sigmaBILL)
          #print ("data: ", h_data.GetBinContent(hbin)) 
          #print (" +-, ", h_data.GetBinError(hbin))
          #print ("MC: ", h_postfit['totalv2'].GetBinContent(hbin))
          #print (" +-, ", h_postfit['totalv2'].GetBinError(hbin))
        ...
        if (hbin > 2):
          ...
          if (data_pull.GetBinContent(hbin) >= 2):

              print " ATTENZIONE "
              print ">>>>>>>>>>>>>>"
              print " data yield : ", h_data.GetBinContent(hbin)  
              print " +- ", h_data.GetBinError(hbin)
              print " BKG error : ", h_postfit['totalv2'].GetBinContent(hbin) 
              print " +- ", h_postfit['totalv2'].GetBinError(hbin)
              print "<<<<<<<<<<<<<<"

    pull_count.SaveAs("pull_"+flavor+region+str(lumi)+".root")
...
######plotter_pull_v2("electron","./inputs/eejj_SR_PostFit_histograms_bkgOnly_PLOT.root","./inputs/eejj_SR_PostFit_histograms_L20_M1_PLOT.root","SR",138,1,"/eos/user/m/mpresill/www/HN/approval_plots/")
######plotter_pull_v2("muon","./inputs/mumujj_SR_PostFit_histograms_bkgOnly_PLOT.root","./inputs/mumujj_SR_PostFit_histograms_L20_M1_PLOT.root","SR",138,1,"/eos/user/m/mpresill/www/HN/approval_plots/")
#####
######plotter_pull_v2("electron","./inputs/eejj_SR_PostFit_histograms_bkgOnly_PLOT.root","./inputs/eejj_SR_PostFit_histograms_L20_M2_PLOT.root","SR",138,2,"/eos/user/m/mpresill/www/HN/approval_plots/")
######plotter_pull_v2("muon","./inputs/mumujj_SR_PostFit_histograms_bkgOnly_PLOT.root","./inputs/mumujj_SR_PostFit_histograms_L20_M2_PLOT.root","SR",138,2,"/eos/user/m/mpresill/www/HN/approval_plots/")

#plotter_pull_v2("electron","./inputs/eejj_SR_PostFit_histograms_bkgOnly_PLOT.root","./inputs/eejj_SR_PostFit_histograms_L13_M2_PLOT.root","SR",138,2,"/eos/user/m/mpresill/www/HN/approval_plots/")
#plotter_pull_v2("muon","./inputs/mumujj_SR_PostFit_histograms_bkgOnly_PLOT.root","./inputs/mumujj_SR_PostFit_histograms_L13_M2_PLOT.root","SR",138,2,"/eos/user/m/mpresill/www/HN/approval_plots/")
#
###DY cr
#plotter_pull_v2("electron","./inputs/eejj_DYcr_PostFit_histograms_bkgOnly_PLOT.root","./inputs/eejj_SR_PostFit_histograms_L20_M2_PLOT.root","DYcr",138,2,"/eos/user/m/mpresill/www/HN/approval_plots/",False)
#plotter_pull_v2("muon","./inputs/mumujj_DYcr_PostFit_histograms_bkgOnly_PLOT.root","./inputs/mumujj_SR_PostFit_histograms_L20_M2_PLOT.root","DYcr",138,2,"/eos/user/m/mpresill/www/HN/approval_plots/",False)
###TOP cr
#plotter_pull_v2("elemu","./inputs/mumujj_TOPcr_PostFit_histograms_bkgOnly_PLOT.root","./inputs/mumujj_SR_PostFit_histograms_L20_M2_PLOT.root","TOPcr",138,2,"/eos/user/m/mpresill/www/HN/approval_plots/",False)



########### THESE ARE FOR FINER BINNING SCENARIO:

plotter_pull_v2("electron","./inputs_finer_binning/eejj_PostFit_histograms_bkgOnly_PLOT_SR.root","./inputs_finer_binning/eejj_PostFit_histograms_L13_M05_PLOT_SR.root","SR",138,0.5,"/eos/user/m/mpresill/www/HN/limits/finer_binning/pull_update/")
plotter_pull_v2("muon","./inputs_finer_binning/mumujj_PostFit_histograms_bkgOnly_PLOT_SR.root","./inputs_finer_binning/mumujj_PostFit_histograms_L13_M05_PLOT_SR.root","SR",138,0.5,"/eos/user/m/mpresill/www/HN/limits/finer_binning/pull_update/")
#
###DY cr
plotter_pull_v2("electron","./inputs_finer_binning/eejj_PostFit_histograms_bkgOnly_PLOT_DYcr.root","./inputs_finer_binning/eejj_PostFit_histograms_L13_M05_PLOT_SR.root","DYcr",138,0.5,"/eos/user/m/mpresill/www/HN/limits/finer_binning/pull_update/",False)
plotter_pull_v2("muon","./inputs_finer_binning/mumujj_PostFit_histograms_bkgOnly_PLOT_DYcr.root","./inputs_finer_binning/mumujj_PostFit_histograms_L13_M05_PLOT_SR.root","DYcr",138,0.5,"/eos/user/m/mpresill/www/HN/limits/finer_binning/pull_update/",False)
###TOP cr
plotter_pull_v2("elemu","./inputs_finer_binning/mumujj_PostFit_histograms_bkgOnly_PLOT_TOPcr.root","./inputs_finer_binning/mumujj_PostFit_histograms_L13_M05_PLOT_SR.root","TOPcr",138,0.5,"/eos/user/m/mpresill/www/HN/limits/finer_binning/pull_update/",False)


## by year plotting, finer binning scenario
#plotter_pull_v2("electron","./inputs_finer_binning/eejj_PostFit_histograms_bkgOnly_PLOT_SR_2016.root","./inputs_finer_binning/eejj_PostFit_histograms_L13_M05_PLOT_SR_2016.root","SR",35.9,0.5,"/eos/user/m/mpresill/www/HN/limits/finer_binning/pull_update/")
#plotter_pull_v2("muon","./inputs_finer_binning/mumujj_PostFit_histograms_bkgOnly_PLOT_SR_2016.root","./inputs_finer_binning/mumujj_PostFit_histograms_L13_M05_PLOT_SR_2016.root","SR",35.9,0.5,"/eos/user/m/mpresill/www/HN/limits/finer_binning/pull_update/")
#plotter_pull_v2("electron","./inputs_finer_binning/eejj_PostFit_histograms_bkgOnly_PLOT_DYcr_2016.root","./inputs_finer_binning/eejj_PostFit_histograms_L13_M05_PLOT_SR_2016.root","DYcr",35.9,0.5,"/eos/user/m/mpresill/www/HN/limits/finer_binning/pull_update/",False)
#plotter_pull_v2("muon","./inputs_finer_binning/mumujj_PostFit_histograms_bkgOnly_PLOT_DYcr_2016.root","./inputs_finer_binning/mumujj_PostFit_histograms_L13_M05_PLOT_SR_2016.root","DYcr",35.9,0.5,"/eos/user/m/mpresill/www/HN/limits/finer_binning/pull_update/",False)
#plotter_pull_v2("elemu","./inputs_finer_binning/mumujj_PostFit_histograms_bkgOnly_PLOT_TOPcr_2016.root","./inputs_finer_binning/mumujj_PostFit_histograms_L13_M05_PLOT_SR_2016.root","TOPcr",35.9,0.5,"/eos/user/m/mpresill/www/HN/limits/finer_binning/pull_update/",False)
#plotter_pull_v2("electron","./inputs_finer_binning/eejj_PostFit_histograms_bkgOnly_PLOT_SR_2017.root","./inputs_finer_binning/eejj_PostFit_histograms_L13_M05_PLOT_SR_2017.root","SR",41.5,0.5,"/eos/user/m/mpresill/www/HN/limits/finer_binning/pull_update/")
#plotter_pull_v2("muon","./inputs_finer_binning/mumujj_PostFit_histograms_bkgOnly_PLOT_SR_2017.root","./inputs_finer_binning/mumujj_PostFit_histograms_L13_M05_PLOT_SR_2017.root","SR",41.5,0.5,"/eos/user/m/mpresill/www/HN/limits/finer_binning/pull_update/")
#plotter_pull_v2("electron","./inputs_finer_binning/eejj_PostFit_histograms_bkgOnly_PLOT_DYcr_2017.root","./inputs_finer_binning/eejj_PostFit_histograms_L13_M05_PLOT_SR_2017.root","DYcr",41.5,0.5,"/eos/user/m/mpresill/www/HN/limits/finer_binning/pull_update/",False)
#plotter_pull_v2("muon","./inputs_finer_binning/mumujj_PostFit_histograms_bkgOnly_PLOT_DYcr_2017.root","./inputs_finer_binning/mumujj_PostFit_histograms_L13_M05_PLOT_SR_2017.root","DYcr",41.5,0.5,"/eos/user/m/mpresill/www/HN/limits/finer_binning/pull_update/",False)
#plotter_pull_v2("elemu","./inputs_finer_binning/mumujj_PostFit_histograms_bkgOnly_PLOT_TOPcr_2017.root","./inputs_finer_binning/mumujj_PostFit_histograms_L13_M05_PLOT_SR_2017.root","TOPcr",41.5,0.5,"/eos/user/m/mpresill/www/HN/limits/finer_binning/pull_update/",False)
#plotter_pull_v2("electron","./inputs_finer_binning/eejj_PostFit_histograms_bkgOnly_PLOT_SR_2018.root","./inputs_finer_binning/eejj_PostFit_histograms_L13_M05_PLOT_SR_2018.root","SR",59.7,0.5,"/eos/user/m/mpresill/www/HN/limits/finer_binning/pull_update/")
#plotter_pull_v2("muon","./inputs_finer_binning/mumujj_PostFit_histograms_bkgOnly_PLOT_SR_2018.root","./inputs_finer_binning/mumujj_PostFit_histograms_L13_M05_PLOT_SR_2018.root","SR",59.7,0.5,"/eos/user/m/mpresill/www/HN/limits/finer_binning/pull_update/")
#plotter_pull_v2("electron","./inputs_finer_binning/eejj_PostFit_histograms_bkgOnly_PLOT_DYcr_2018.root","./inputs_finer_binning/eejj_PostFit_histograms_L13_M05_PLOT_SR_2018.root","DYcr",59.7,0.5,"/eos/user/m/mpresill/www/HN/limits/finer_binning/pull_update/",False)
#plotter_pull_v2("muon","./inputs_finer_binning/mumujj_PostFit_histograms_bkgOnly_PLOT_DYcr_2018.root","./inputs_finer_binning/mumujj_PostFit_histograms_L13_M05_PLOT_SR_2018.root","DYcr",59.7,0.5,"/eos/user/m/mpresill/www/HN/limits/finer_binning/pull_update/",False)
#plotter_pull_v2("elemu","./inputs_finer_binning/mumujj_PostFit_histograms_bkgOnly_PLOT_TOPcr_2018.root","./inputs_finer_binning/mumujj_PostFit_histograms_L13_M05_PLOT_SR_2018.root","TOPcr",59.7,0.5,"/eos/user/m/mpresill/www/HN/limits/finer_binning/pull_update/",False)
...
### testing another rebinning scenario:
#plotter_pull_v2("electron","./inputs_finer_binning/eejj_PostFit_histograms_bkgOnly_PLOT_SR-TEST.root","./inputs_finer_binning/eejj_PostFit_histograms_L13_M05_PLOT_SR-TEST.root","SR",138,0.5,"/eos/user/m/mpresill/www/HN/limits/finer_binning/tmp/")

#plotter_pull_v2("muon","./tmp/mumujj_PostFit_histograms_bkgOnly_REBINNED.root","./tmp/mumujj_PostFit_histograms_L13_M05_REBINNED.root","SR",138,0.5,"/eos/user/m/mpresill/www/HN/limits/finer_binning/test/")
##DY cr
#plotter_pull_v2("muon","./tmp/mumujj_PostFit_histograms_bkgOnly_REBINNED.root","./tmp/mumujj_PostFit_histograms_L13_M05_REBINNED.root","DYcr",138,0.5,"/eos/user/m/mpresill/www/HN/limits/finer_binning/test/",False)
##TOP cr
#plotter_pull_v2("elemu","./tmp/mumujj_PostFit_histograms_bkgOnly_REBINNED.root","./tmp/mumujj_PostFit_histograms_L13_M05_REBINNED.root","TOPcr",138,0.5,"/eos/user/m/mpresill/www/HN/limits/finer_binning/test/",False)