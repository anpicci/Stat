...
_fout = ROOT.TFile.Open(str(sys.argv[1])+"_PLOT_"+region+"_2018.root", "RECREATE")
...
for i in range(1,10):
    h_pre_top.SetBinContent(i,h_top_pre_18.GetBinContent(i))  
    h_pre_top.SetBinError(i,h_top_pre_18.GetBinError(i))
    ###
    h_pre_dy.SetBinContent(i,h_dy_pre_18.GetBinContent(i))  
    h_pre_dy.SetBinError(i,h_dy_pre_18.GetBinError(i))
    ###
    h_pre_other.SetBinContent(i,h_other_pre_18.GetBinContent(i))  
    h_pre_other.SetBinError(i,h_other_pre_18.GetBinError(i))
    ###
    h_pre_bkg.SetBinContent(i,h_TotalBkg_pre_18.GetBinContent(i))  
    h_pre_bkg.SetBinError(i,h_TotalBkg_pre_18.GetBinError(i))
    ###
    h_data_obs.SetBinContent(i,h_data_obs_18.GetBinContent(i))  
    h_data_obs.SetBinError(i,h_data_obs_18.GetBinError(i))
...
for i in range(1,10):
    h_top.SetBinContent(i,h_top_18.GetBinContent(i))  
    h_top.SetBinError(i,h_top_18.GetBinError(i))
    ###
    h_dy.SetBinContent(i,h_dy_18.GetBinContent(i))  
    h_dy.SetBinError(i,h_dy_18.GetBinError(i))
    ###
    h_other.SetBinContent(i,h_other_18.GetBinContent(i))  
    h_other.SetBinError(i,h_other_18.GetBinError(i))
    ###
    h_bkg.SetBinContent(i,h_TotalBkg_18.GetBinContent(i))  
    h_bkg.SetBinError(i,h_TotalBkg_18.GetBinError(i))
    #print("error: ", h_TotalBkg_18.GetBinError(i) )
    ###
    h_procs.SetBinContent(i,h_TotalProcs_18.GetBinContent(i))  
    h_procs.SetBinError(i,h_TotalProcs_18.GetBinError(i))
    ...
    h_pre_sig.SetBinContent(i,h_TotalSig_pre_18.GetBinContent(i))  
    h_pre_sig.SetBinError(i,h_TotalSig_pre_18.GetBinError(i))
