...
#######    adding the three years top, other and dy
h_top_pre_16.Add(h_top_pre_17)
h_top_pre_16.Add(h_top_pre_18)
h_top_16.Add(h_top_17)
h_top_16.Add(h_top_18)

h_other_pre_16.Add(h_other_pre_17)
h_other_pre_16.Add(h_other_pre_18)
h_other_16.Add(h_other_17)
h_other_16.Add(h_other_18)

if region != "TOPcr":
    h_dy_pre_16.Add(h_dy_pre_17)
h_dy_pre_16.Add(h_dy_pre_18)
if region != "TOPcr":
    h_dy_16.Add(h_dy_17)
h_dy_16.Add(h_dy_18)
#######    adding total Sig, total Bkgs & data
h_TotalSig_pre_16.Add(h_TotalSig_pre_17)
h_TotalSig_pre_16.Add(h_TotalSig_pre_18)

h_TotalBkg_pre_16.Add(h_TotalBkg_pre_17)
h_TotalBkg_pre_16.Add(h_TotalBkg_pre_18)

h_data_obs_16.Add(h_data_obs_17)
h_data_obs_16.Add(h_data_obs_18)

h_TotalBkg_16.Add(h_TotalBkg_17)
h_TotalBkg_16.Add(h_TotalBkg_18)
#h_TotalBkg_16.Sumw2()

h_TotalProcs_16.Add(h_TotalProcs_17)
h_TotalProcs_16.Add(h_TotalProcs_18)
##########################



#### filling the new file with its folder structure:
_fout = ROOT.TFile.Open(str(sys.argv[1])+"_PLOT_"+region+".root", "RECREATE")
...
for i in range(1,10):
    h_pre_top.SetBinContent(i,h_top_pre_16.GetBinContent(i))  
    h_pre_top.SetBinError(i,h_top_pre_16.GetBinError(i))
    ###
    h_pre_dy.SetBinContent(i,h_dy_pre_16.GetBinContent(i))  
    h_pre_dy.SetBinError(i,h_dy_pre_16.GetBinError(i))
    ###
    h_pre_other.SetBinContent(i,h_other_pre_16.GetBinContent(i))  
    h_pre_other.SetBinError(i,h_other_pre_16.GetBinError(i))
    ###
    h_pre_bkg.SetBinContent(i,h_TotalBkg_pre_16.GetBinContent(i))  
    h_pre_bkg.SetBinError(i,h_TotalBkg_pre_16.GetBinError(i))
    ###
    h_data_obs.SetBinContent(i,h_data_obs_16.GetBinContent(i))  
    h_data_obs.SetBinError(i,h_data_obs_16.GetBinError(i))
...
for i in range(1,10):
    h_top.SetBinContent(i,h_top_16.GetBinContent(i))  
    h_top.SetBinError(i,h_top_16.GetBinError(i))
    ###
    h_dy.SetBinContent(i,h_dy_16.GetBinContent(i))  
    h_dy.SetBinError(i,h_dy_16.GetBinError(i))
    ###
    h_other.SetBinContent(i,h_other_16.GetBinContent(i))  
    h_other.SetBinError(i,h_other_16.GetBinError(i))
    ###
    h_bkg.SetBinContent(i,h_TotalBkg_16.GetBinContent(i))  
    h_bkg.SetBinError(i,h_TotalBkg_16.GetBinError(i))
    #print("error: ", h_TotalBkg_16.GetBinError(i) )
    ###
    h_procs.SetBinContent(i,h_TotalProcs_16.GetBinContent(i))  
    h_procs.SetBinError(i,h_TotalProcs_16.GetBinError(i))
    ...
    h_pre_sig.SetBinContent(i,h_TotalSig_pre_16.GetBinContent(i))  
    h_pre_sig.SetBinError(i,h_TotalSig_pre_16.GetBinError(i))

    print("summ ", h_top.GetBinContent(i)+h_dy.GetBinContent(i)+h_other.GetBinContent(i) )
    print("total post ", h_bkg.GetBinContent(i))
    print("total post ERR ", h_bkg.GetBinError(i))
    print("======")
