...
def CMS_lumi(pad,  lumi_sqrtS,  iPosX , lepText):
    ...
    latex.DrawLatex(1-r,1-t+lumiTextOffset*t*1.5,lumiText)
    ...
    if( not outOfFrame ):
        if( drawLogo ):
            ...
            latex.DrawLatex(posX_ + 0.035, posY_, cmsText)
            if( writeExtraText ) :
                latex.SetTextFont(extraTextFont)
                latex.SetTextAlign(align_)
                latex.SetTextSize(extraTextSize*t*2)
                Ylatex = posY_ - relExtraDY*extraTextSize*t*1.12
                if extraText != "":
                    latex.DrawLatex(posX_, posY_- relExtraDY*cmsTextSize*t, extraText)
                    Ylatex = Ylatex - relExtraDY*cmsTextSize*t - 1
                ...
                latex.DrawLatex(posX_ + 0.020, Ylatex , lepText.split("\n")[0])
                #latex.DrawLatex(posX_, posY_- relExtraDY*cmsTextSize*t - 2*relExtraDY*extraTextSize*t , lepText.split("\n")[1])
                latex.DrawLatex(posX_ + 0.091, Ylatex - relExtraDY*extraTextSize*t*1.12 , lepText.split("\n")[1])
        ...
        latex.SetTextAlign(align_)
        latex.DrawLatex(posX_ + 0.5, posY_, extraText)      
