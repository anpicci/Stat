...
def plotter(flavor,fitdiag_file,SignalFile,region,lumi,Mass,outdir="./output",sb=True,year=161718,LogX=True):
...
######plotter("electron","./inputs/eejj_SR_PostFit_histograms_bkgOnly_PLOT.root","./inputs/eejj_SR_PostFit_histograms_L20_M1_PLOT.root","SR",138,1,"/eos/user/m/mpresill/www/HN/approval_plots/")
######plotter("muon","./inputs/mumujj_SR_PostFit_histograms_bkgOnly_PLOT.root","./inputs/mumujj_SR_PostFit_histograms_L20_M1_PLOT.root","SR",138,1,"/eos/user/m/mpresill/www/HN/approval_plots/")
#####
######plotter("electron","./inputs/eejj_SR_PostFit_histograms_bkgOnly_PLOT.root","./inputs/eejj_SR_PostFit_histograms_L20_M2_PLOT.root","SR",138,2,"/eos/user/m/mpresill/www/HN/approval_plots/")
######plotter("muon","./inputs/mumujj_SR_PostFit_histograms_bkgOnly_PLOT.root","./inputs/mumujj_SR_PostFit_histograms_L20_M2_PLOT.root","SR",138,2,"/eos/user/m/mpresill/www/HN/approval_plots/")

#plotter("electron","./inputs/eejj_SR_PostFit_histograms_bkgOnly_PLOT.root","./inputs/eejj_SR_PostFit_histograms_L13_M2_PLOT.root","SR",138,2,"/eos/user/m/mpresill/www/HN/approval_plots/")
#plotter("muon","./inputs/mumujj_SR_PostFit_histograms_bkgOnly_PLOT.root","./inputs/mumujj_SR_PostFit_histograms_L13_M2_PLOT.root","SR",138,2,"/eos/user/m/mpresill/www/HN/approval_plots/")
#
###DY cr
#plotter("electron","./inputs/eejj_DYcr_PostFit_histograms_bkgOnly_PLOT.root","./inputs/eejj_SR_PostFit_histograms_L20_M2_PLOT.root","DYcr",138,2,"/eos/user/m/mpresill/www/HN/approval_plots/",False)
#plotter("muon","./inputs/mumujj_DYcr_PostFit_histograms_bkgOnly_PLOT.root","./inputs/mumujj_SR_PostFit_histograms_L20_M2_PLOT.root","DYcr",138,2,"/eos/user/m/mpresill/www/HN/approval_plots/",False)
###TOP cr
#plotter("elemu","./inputs/mumujj_TOPcr_PostFit_histograms_bkgOnly_PLOT.root","./inputs/mumujj_SR_PostFit_histograms_L20_M2_PLOT.root","TOPcr",138,2,"/eos/user/m/mpresill/www/HN/approval_plots/",False)



########### THESE ARE FOR FINER BINNING SCENARIO:

plotter("electron","./inputs_finer_binning/eejj_PostFit_histograms_bkgOnly_PLOT_SR.root","./inputs_finer_binning/eejj_PostFit_histograms_L13_M05_PLOT_SR.root","SR",138,0.5,"/eos/user/m/mpresill/www/HN/limits/finer_binning/CWR/")
plotter("muon","./inputs_finer_binning/mumujj_PostFit_histograms_bkgOnly_PLOT_SR.root","./inputs_finer_binning/mumujj_PostFit_histograms_L13_M05_PLOT_SR.root","SR",138,0.5,"/eos/user/m/mpresill/www/HN/limits/finer_binning/CWR/")

##DY cr
plotter("electron","./inputs_finer_binning/eejj_PostFit_histograms_bkgOnly_PLOT_DYcr.root","./inputs_finer_binning/eejj_PostFit_histograms_L13_M05_PLOT_SR.root","DYcr",138,0.5,"/eos/user/m/mpresill/www/HN/limits/finer_binning/CWR/",False)
plotter("muon","./inputs_finer_binning/mumujj_PostFit_histograms_bkgOnly_PLOT_DYcr.root","./inputs_finer_binning/mumujj_PostFit_histograms_L13_M05_PLOT_SR.root","DYcr",138,0.5,"/eos/user/m/mpresill/www/HN/limits/finer_binning/CWR/",False)
##TOP cr
plotter("elemu","./inputs_finer_binning/mumujj_PostFit_histograms_bkgOnly_PLOT_TOPcr.root","./inputs_finer_binning/mumujj_PostFit_histograms_L13_M05_PLOT_SR.root","TOPcr",138,0.5,"/eos/user/m/mpresill/www/HN/limits/finer_binning/CWR/",False)



## by year plotting, finer binning scenario
#plotter("electron","./inputs_finer_binning/eejj_PostFit_histograms_bkgOnly_PLOT_SR_2016.root","./inputs_finer_binning/eejj_PostFit_histograms_L13_M05_PLOT_SR_2016.root","SR",35.9,0.5,"/eos/user/m/mpresill/www/HN/limits/finer_binning/")
#plotter("muon","./inputs_finer_binning/mumujj_PostFit_histograms_bkgOnly_PLOT_SR_2016.root","./inputs_finer_binning/mumujj_PostFit_histograms_L13_M05_PLOT_SR_2016.root","SR",35.9,0.5,"/eos/user/m/mpresill/www/HN/limits/finer_binning/")
#plotter("electron","./inputs_finer_binning/eejj_PostFit_histograms_bkgOnly_PLOT_DYcr_2016.root","./inputs_finer_binning/eejj_PostFit_histograms_L13_M05_PLOT_SR_2016.root","DYcr",35.9,0.5,"/eos/user/m/mpresill/www/HN/limits/finer_binning/",False)
#plotter("muon","./inputs_finer_binning/mumujj_PostFit_histograms_bkgOnly_PLOT_DYcr_2016.root","./inputs_finer_binning/mumujj_PostFit_histograms_L13_M05_PLOT_SR_2016.root","DYcr",35.9,0.5,"/eos/user/m/mpresill/www/HN/limits/finer_binning/",False)
#plotter("elemu","./inputs_finer_binning/mumujj_PostFit_histograms_bkgOnly_PLOT_TOPcr_2016.root","./inputs_finer_binning/mumujj_PostFit_histograms_L13_M05_PLOT_SR_2016.root","TOPcr",35.9,0.5,"/eos/user/m/mpresill/www/HN/limits/finer_binning/",False)
#
#plotter("electron","./inputs_finer_binning/eejj_PostFit_histograms_bkgOnly_PLOT_SR_2017.root","./inputs_finer_binning/eejj_PostFit_histograms_L13_M05_PLOT_SR_2017.root","SR",41.5,0.5,"/eos/user/m/mpresill/www/HN/limits/finer_binning/")
#plotter("muon","./inputs_finer_binning/mumujj_PostFit_histograms_bkgOnly_PLOT_SR_2017.root","./inputs_finer_binning/mumujj_PostFit_histograms_L13_M05_PLOT_SR_2017.root","SR",41.5,0.5,"/eos/user/m/mpresill/www/HN/limits/finer_binning/")
#plotter("electron","./inputs_finer_binning/eejj_PostFit_histograms_bkgOnly_PLOT_DYcr_2017.root","./inputs_finer_binning/eejj_PostFit_histograms_L13_M05_PLOT_SR_2017.root","DYcr",41.5,0.5,"/eos/user/m/mpresill/www/HN/limits/finer_binning/",False)
#plotter("muon","./inputs_finer_binning/mumujj_PostFit_histograms_bkgOnly_PLOT_DYcr_2017.root","./inputs_finer_binning/mumujj_PostFit_histograms_L13_M05_PLOT_SR_2017.root","DYcr",41.5,0.5,"/eos/user/m/mpresill/www/HN/limits/finer_binning/",False)
#plotter("elemu","./inputs_finer_binning/mumujj_PostFit_histograms_bkgOnly_PLOT_TOPcr_2017.root","./inputs_finer_binning/mumujj_PostFit_histograms_L13_M05_PLOT_SR_2017.root","TOPcr",41.5,0.5,"/eos/user/m/mpresill/www/HN/limits/finer_binning/",False)
#
#plotter("electron","./inputs_finer_binning/eejj_PostFit_histograms_bkgOnly_PLOT_SR_2018.root","./inputs_finer_binning/eejj_PostFit_histograms_L13_M05_PLOT_SR_2018.root","SR",59.7,0.5,"/eos/user/m/mpresill/www/HN/limits/finer_binning/")
#plotter("muon","./inputs_finer_binning/mumujj_PostFit_histograms_bkgOnly_PLOT_SR_2018.root","./inputs_finer_binning/mumujj_PostFit_histograms_L13_M05_PLOT_SR_2018.root","SR",59.7,0.5,"/eos/user/m/mpresill/www/HN/limits/finer_binning/")
#plotter("electron","./inputs_finer_binning/eejj_PostFit_histograms_bkgOnly_PLOT_DYcr_2018.root","./inputs_finer_binning/eejj_PostFit_histograms_L13_M05_PLOT_SR_2018.root","DYcr",59.7,0.5,"/eos/user/m/mpresill/www/HN/limits/finer_binning/",False)
#plotter("muon","./inputs_finer_binning/mumujj_PostFit_histograms_bkgOnly_PLOT_DYcr_2018.root","./inputs_finer_binning/mumujj_PostFit_histograms_L13_M05_PLOT_SR_2018.root","DYcr",59.7,0.5,"/eos/user/m/mpresill/www/HN/limits/finer_binning/",False)
#plotter("elemu","./inputs_finer_binning/mumujj_PostFit_histograms_bkgOnly_PLOT_TOPcr_2018.root","./inputs_finer_binning/mumujj_PostFit_histograms_L13_M05_PLOT_SR_2018.root","TOPcr",59.7,0.5,"/eos/user/m/mpresill/www/HN/limits/finer_binning/",False)
