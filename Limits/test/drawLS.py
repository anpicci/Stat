...
def draw2D():
    ...
    for cinit, lambpow in lambdas.items(): 
    ...
    cc2.SaveAs(os.path.dirname(opt.in1) + "/LS_" + str(opt.coeff) + ".png")
    cc2.SaveAs(os.path.dirname(opt.in1) + "/LS_" + str(opt.coeff) + ".pdf")
    cc2.SaveAs(os.path.dirname(opt.in1) + "/LS_" + str(opt.coeff) + ".root")
