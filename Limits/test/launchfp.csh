...
#python FitAndPlot.py --year RunII --folder vUL040 --eft cW:FM0_1p0 --fit m_o1 --notImpacts --notUncBreak --tDMcut #--notCI
...
#python FitAndPlot.py --year RunII --folder vUL040 --eft FM0_1p0 --fit m_o1 --notImpacts --notUncBreak --noFit
