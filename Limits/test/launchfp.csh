...
#python FitAndPlot.py --year RunII --folder vUL030 --eft cW:FT0_1p0 --fit m_o1 --notCI --notImpacts --notUncBreak
#python FitAndPlot.py --year RunII --folder vUL035 --eft cW --fit m_o1 
#python FitAndPlot.py --year RunII --folder vUL035 --eft FT1_1p0 --fit m_o1 --notCI --notImpacts --notUncBreak
#python FitAndPlot.py --year RunII --folder vUL030 --eft cW:cHW --fit m_o1 --notImpacts --notUncBreak

#python FitAndPlot.py --year RunII --folder vUL035 --sm --vbs --fit BDT_SM_UL035_v2 --notUncBreak --notImpacts
