...
python FitAndPlot.py --year RunII --folder vUL040 --eft FM0_1p0 --fit m_o1 --notUncBreak --tDMcut --noFit --notCI
...
#python FitAndPlot.py --year RunII --folder vUL035 --eft FS2_1p0 --fit DNN_FS_UL035_novar_fix --notUncBreak --tDMcut --noFit --notCI
...
#python FitAndPlot.py --year RunII --folder vUL035 --eft FM7_1p0 --fit DNN_FM_UL035_novar --tDMcut --notUncBreak --noFit --notCI
...
#python FitAndPlot.py --year 2017 --folder vUL035 --sm --vbs --pol LL --fit m_o1 --notImpacts --notUncBreak

#python FitAndPlot.py --year RunII --folder vUL035 --eft cHW --fit DNN_cHW_UL025_bal,DNN_cHW_UL025_bal,DNN_cW_UL025_bal_v2,m_o1,m_o1 --cr countings,DNN_cHW_UL025_bal,DNN_cW_UL025_bal_v2,countings,m_o1 --notImpacts --noFit --doPost
